...
- **Curated, right-sized.** Your favorites are grouped by genre (Classical /
  Jazz / Blues / Country / Rock / Pop / Other) via `s`, and hot-picked `1-9`
  at all times — not a firehose of 40,000 streams.
...
(Classical / Jazz / Blues / Country / Rock / Pop / Other): your favorites
grouped by genre, with curated catalogs filling those submenus even when your
favorites list is full. `k` leaps straight to this book.
